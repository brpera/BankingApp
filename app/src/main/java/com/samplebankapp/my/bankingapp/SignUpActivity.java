...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initDepo = (TextView)findViewById(R.id.textView12);
    ...
    void smartCounter(){
        ...
        accID = (TextView)findViewById(R.id.txtAccID);
    ...
    public void showHome(View view)
    {
        ...
        mname = (EditText)findViewById(R.id.txtMidName);
        lname = (EditText)findViewById(R.id.txtLastName);
        address = (EditText)findViewById(R.id.txtAddress);
        contact = (EditText)findViewById(R.id.txtContactNo);
        pw = (EditText)findViewById(R.id.txtPassword);
        accID = (TextView)findViewById(R.id.txtAccID);
        initDepo = (TextView)findViewById(R.id.textView12);
        confpw = (EditText)findViewById(R.id.txtConfirm);
